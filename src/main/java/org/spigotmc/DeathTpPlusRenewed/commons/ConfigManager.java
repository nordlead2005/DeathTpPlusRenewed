...
public class ConfigManager {
    ...
    /**
     * Enable BlockLocker Support
     */
    private boolean enableBlockLocker = true;
    /**
     * Enable LWC Support
     */
    ...
    /**
     * Name of the item you must have in your hand to teleport. Will remove 1 of these when the command is given. Leave 0 for free teleports
     */
    ...
    /**
     * If you are not locking your chests with BlockLocker or LWC but still want them to be
    ...
    /**
     * Allow chest/signs to replace these blocks
     */
    private List<String> replaceableBlocks = new ArrayList<String>(Arrays.asList(new String[]{
        "acacia_sapling", "oak_sapling", "spruce_sapling", "dark_oak_sapling", "birch_sapling", "bamboo_sapling",
        "dandelion", "poppy", "blue_orchid", "allium", "azure_bluet", "red_tulip", "orange_tulip", "white_tulip",
        "pink_tulip", "oxeye_daisy",
        "brown_mushroom", "red_mushroom",
        "fire",
        "carrot", "carrots", "potato", "potatoes", "sugar_cane", "wheat",
        "dirt", "gravel", "lava", "sand", "snow",  "water"
    }));
 ...
 */
    ...
    private void customDefaultConfig() {
        ...
        // Default DeathTpPlusRenewed Variables
        log.debug("config", config);
        config.addDefault("dateFormat", dateFormat);
        config.addDefault("timeFormat", timeFormat);
        config.addDefault("enableBlockLocker", enableBlockLocker);
        ...
        config.addDefault("replaceableBlocks", replaceableBlocks);
        // TombStone Features (Removal)
    ...
    private void loadCustomConfig() {
        ...
        enableBlockLocker = config.getBoolean("enableBlockLocker");
        ...
        replaceableBlocks = checkList(config.getStringList("replaceableBlocks"), replaceableBlocks);
        // Tombstone Features (Removal)
        ...
        log.debug("enableBlockLocker", enableBlockLocker);
        ...
        log.debug("replaceableBlocks", replaceableBlocks);
    ...
    private void writeCustomConfig(PrintWriter stream) {
        ...
        stream.println();
        stream.println("# Enable BlockLocker Support");
        stream.println("enableBlockLocker: " + enableBlockLocker);
        stream.println();
        ...
        stream.println();
        stream.println("# Name of the item you must have in your hand to teleport. Will remove 1 of these when the command is given. Leave 0 for free teleports ");
        ...
        stream.println();
        stream.println("# If you are not locking your chests with BlockLocker or LWC but still want them to be");
        ...
        stream.println();
        stream.println("# replaceable blocks for tomb/signs");
        stream.println("replaceableBlocks:");
        for (String msg : replaceableBlocks) {
            stream.println("    - \"" + msg + "\"");
        }
        stream.println();
    ...
    public boolean isEnableBlockLocker() {
        return enableBlockLocker;
    }
