...
/**
 * The DeathMessages Class allows you to write a custom deathMessageFileConfig file to store all death messages for DeathTpPlusRenewed.
 *
 * @author Don Redhorse
 */
...
// Nothing to change from here to ==>>>
	...
	// The org.spigotmc.DeathTpPlusRenewed.commcon.DefaultLogger should be renamed to the name of the class you did change the original org.spigotmc.DeathTpPlusRenewed.helpers.LoggerClass too.
	/**
...
// Helper Variables
    ...
    /**
     * Array which holds default Vindictor messages
     */
...
// Default Death Messages
		...
		defaultDrownedMessages = new String[] {
				"&5%n&7 discovered tridents.",
				"&5%n&7 became friends with a water zombie.",
				"&5%n&7 lost an underwater battle with a zombie."
		};
		deathMessages.put(DeathEventType.DROWNED, Arrays.asList(defaultDrownedMessages));
        ...
        /** Creating the default Guardian Kill messages*/
        defaultGuardianMessages = new String[]{
                "&5%n&7 took laser fire!"
        };
        deathMessages.put(DeathEventType.GUARDIAN, Arrays.asList(defaultGuardianMessages));
		
        /** Creating the default Elder Guardian Kill messages*/
        defaultElderGuardianMessages = new String[]{
                "&5%n&7 took major laser damage!"
        };
        deathMessages.put(DeathEventType.ELDER_GUARDIAN, Arrays.asList(defaultElderGuardianMessages));
		
        /** Creating the default Pillager Kill messages*/
        defaultPillagerMessages = new String[]{
                "&5%n&7 failed to defend the village!",
				"&5%n&7 got taken out by a scout.",
				"&5%n&7 was on the wrong end of a crossbow.",
				"&5%n&7 hasn't beaten an evoker yet."
        };
        deathMessages.put(DeathEventType.PILLAGER, Arrays.asList(defaultPillagerMessages));
		
        /** Creating the default Evoker Kill messages*/
        defaultEvokerMessages = new String[]{
                "&5%n&7 got killed by an Evoker."
        };
        deathMessages.put(DeathEventType.EVOKER, Arrays.asList(defaultEvokerMessages));
		
        /** Creating the default Ravager Kill messages*/
        defaultRavagerMessages = new String[]{
				"&5%n&7 got trampled by a Ravager.",
				"&5%n&7 tried to go on a Ravager ride.",
        };
        deathMessages.put(DeathEventType.RAVAGER, Arrays.asList(defaultRavagerMessages));
		
        /** Creating the default Vex Kill messages*/
        defaultVexMessages = new String[]{
				"&5%n&7 tried to hide from a Vex.",
				"&5%n&7 was killed by a fairy.",
        };
        deathMessages.put(DeathEventType.VEX, Arrays.asList(defaultVexMessages));

        /** Creating the default Endermite Kill messages*/
		defaultEndermiteMessages = new String[]{
			"&5%n&7 warped one to many times."
		};
		deathMessages.put(DeathEventType.ENDERMITE, Arrays.asList(defaultEndermiteMessages));

        /** Creating the default Vindicator Kill messages*/
		defaultVindicatorMessages = new String[]{
			"&5%n&7 was vindicated?"
		};
		deathMessages.put(DeathEventType.VINDICATOR, Arrays.asList(defaultVindicatorMessages));

        /** Creating the default Stray Kill messages*/
		defaultStrayMessages = new String[]{
			"&5%n&7 was killed by a Stray."
		};
		deathMessages.put(DeathEventType.STRAY, Arrays.asList(defaultStrayMessages));

        /** Creating the default Shulker Kill messages*/
		defaultShulkerMessages = new String[]{
			"&5%n&7 was levitated to death."
		};
		deathMessages.put(DeathEventType.SHULKER, Arrays.asList(defaultShulkerMessages));

        /** Creating the default PolarBear Kill messages*/
		defaultPolarBearMessages = new String[]{
			"&5%n&7 got between a mom and her cub."
		};
		deathMessages.put(DeathEventType.POLAR_BEAR, Arrays.asList(defaultPolarBearMessages));

        /** Creating the default Phantom Kill messages*/
		defaultPhantomMessages = new String[]{
			"&5%n&7 should probably sleep more.",
			"&5%n&7 was terrorized from above.",
			"&5%n&7 needs to take a nap."
		};
		deathMessages.put(DeathEventType.PHANTOM, Arrays.asList(defaultPhantomMessages));

        /** Creating the default Panda Kill messages*/
		defaultPandaMessages = new String[]{
			"&5%n&7 made a panda angry."
		};
		deathMessages.put(DeathEventType.PANDA, Arrays.asList(defaultPandaMessages));
...
// DeathTp Messages
		...
		deathMessages.put(DeathEventType.HUSK, ConfigManager.checkList(deathMessageFileConfig.getStringList("husk"), Arrays.asList(defaultHuskMessages)));
		deathMessages.put(DeathEventType.GUARDIAN, ConfigManager.checkList(deathMessageFileConfig.getStringList("guardian"),Arrays.asList(defaultGuardianMessages)));
		deathMessages.put(DeathEventType.ELDER_GUARDIAN, ConfigManager.checkList(deathMessageFileConfig.getStringList("elder-guardian"),Arrays.asList(defaultElderGuardianMessages)));
		deathMessages.put(DeathEventType.ENDERMITE, ConfigManager.checkList(deathMessageFileConfig.getStringList("endermite"), Arrays.asList(defaultEndermiteMessages)));
		deathMessages.put(DeathEventType.EVOKER, ConfigManager.checkList(deathMessageFileConfig.getStringList("evoker"), Arrays.asList(defaultEvokerMessages)));
		deathMessages.put(DeathEventType.PILLAGER, ConfigManager.checkList(deathMessageFileConfig.getStringList("pillager"), Arrays.asList(defaultPillagerMessages)));
		deathMessages.put(DeathEventType.RAVAGER, ConfigManager.checkList(deathMessageFileConfig.getStringList("ravager"), Arrays.asList(defaultRavagerMessages)));
		deathMessages.put(DeathEventType.VINDICATOR, ConfigManager.checkList(deathMessageFileConfig.getStringList("vindicator"), Arrays.asList(defaultVindicatorMessages)));
		deathMessages.put(DeathEventType.VEX, ConfigManager.checkList(deathMessageFileConfig.getStringList("vex"), Arrays.asList(defaultVexMessages)));
		deathMessages.put(DeathEventType.DROWNED, ConfigManager.checkList(deathMessageFileConfig.getStringList("drowned"), Arrays.asList(defaultDrownedMessages)));
		deathMessages.put(DeathEventType.POLAR_BEAR, ConfigManager.checkList(deathMessageFileConfig.getStringList("polar-bear"), Arrays.asList(defaultPolarBearMessages)));
		deathMessages.put(DeathEventType.PANDA, ConfigManager.checkList(deathMessageFileConfig.getStringList("panda"), Arrays.asList(defaultPandaMessages)));
		deathMessages.put(DeathEventType.SHULKER, ConfigManager.checkList(deathMessageFileConfig.getStringList("shulker"), Arrays.asList(defaultShulkerMessages)));
		deathMessages.put(DeathEventType.STRAY, ConfigManager.checkList(deathMessageFileConfig.getStringList("stray"), Arrays.asList(defaultStrayMessages)));
		deathMessages.put(DeathEventType.PHANTOM, ConfigManager.checkList(deathMessageFileConfig.getStringList("phantom"), Arrays.asList(defaultPhantomMessages)));
		...
		for (DeathEventType deathEventType : DeathEventType.values()) {
			...
			log.warning(deathEventType +"type has messages: " + (boolean)(deathMessages.get(deathEventType) != null));
...
// Setting up the deathMessageFileConfig
	 ...
	 * and if {@link org.spigotmc.DeathTpPlusRenewed.commons.ConfigManager#isAutoUpdateConfig()} is true we update the configuration {@link #updateDeathMessages()}
